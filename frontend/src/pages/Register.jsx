...
function FormContent({ form, errors, loading, showPassword, handleChange, handleSubmit, setShowPassword }) {
  return (
    <div className="form-box">
      ...
      <input name="nik" value={form.nik} onChange={handleChange} className={`f-input${errors.nik ? " error" : ""}`} />

      <label className="f-label">Nama Lengkap</label>
      <input name="nama" value={form.nama} onChange={handleChange} className={`f-input${errors.nama ? " error" : ""}`} />

      <label className="f-label">Email</label>
      <input name="email" type="email" value={form.email} onChange={handleChange} className={`f-input${errors.email ? " error" : ""}`} />
      ...
      <input name="no_hp" value={form.no_hp} onChange={handleChange} className="f-input" />

      <label className="f-label">Tempat Lahir</label>
      <input name="tempat_lahir" value={form.tempat_lahir} onChange={handleChange} className="f-input" />

      <label className="f-label">Tanggal Lahir</label>
      <input name="tanggal_lahir" type="date" value={form.tanggal_lahir} onChange={handleChange} className="f-input" />

      <label className="f-label">Jenis Kelamin</label>
      <select name="jenis_kelamin" value={form.jenis_kelamin} onChange={handleChange} className="f-input">
      ...
      <input name="status_perkawinan" value={form.status_perkawinan} onChange={handleChange} className="f-input" />

      <label className="f-label">Pekerjaan</label>
      <input name="pekerjaan" value={form.pekerjaan} onChange={handleChange} className="f-input" />

      <label className="f-label">Alamat</label>
      <textarea name="alamat" value={form.alamat} onChange={handleChange} className="f-input"></textarea>
