...
<head>
    ...
    <style>
        ...
        .gradient-text {
            background: linear-gradient(135deg, #f43f3f 0%, #ec4899 100%);
...
<body class="bg-stone-50 font-sans">
    ...
    <nav x-data="{ open:false, scrolled:false }" @scroll.window="scrolled = window.scrollY > 10" :class="scrolled ? 'bg-white/90 shadow-sm' : 'bg-white/95'" class="sticky top-0 z-50 backdrop-blur-sm transition-all duration-300">
            ...
            <div class="flex justify-between h-16 items-center">
                <a href="#" class="flex items-center">
                    <span class="text-rose-600 font-bold text-2xl flex items-center">
                        <img src="assets/img/bpr-logo-2.png"
                            alt="BookBox"
                            class="h-6 sm:h-7 md:h-8 lg:h-10 w-auto mr-2">
                        BPR Supra
                    </span>
                </a>
                <div class="hidden md:flex items-center space-x-8">
                    <a href="#home" class="text-gray-600 hover:text-rose-600 transition-all duration-300 hover:scale-105">Beranda</a>
                    <a href="#gift" class="text-gray-600 hover:text-rose-600 transition-all duration-300 hover:scale-105">Tentang</a>
                    <a href="#faq" class="text-gray-600 hover:text-rose-600 transition-all duration-300 hover:scale-105">Formulir</a>
                    <a href="#review" class="text-gray-600 hover:text-rose-600 transition-all duration-300 hover:scale-105">Ulasan</a>
        ...
        <div id="mobile-menu" x-cloak x-show="open" x-transition.origin.top class="md:hidden bg-white border-t border-stone-200">
            <div class="px-4 py-3 space-y-2">
                <a @click="open=false" href="#home" class="block px-3 py-2 rounded-lg hover:bg-stone-100 text-gray-700">Beranda</a>
                <a @click="open=false" href="#gift" class="block px-3 py-2 rounded-lg hover:bg-stone-100 text-gray-700">Tentang</a>
                <a @click="open=false" href="#faq" class="block px-3 py-2 rounded-lg hover:bg-stone-100 text-gray-700">Formulir</a>
                <a @click="open=false" href="#review" class="block px-3 py-2 rounded-lg hover:bg-stone-100 text-gray-700">Ulasan</a>
                <button class="w-full bg-rose-500 text-white px-4 py-2 rounded-lg hover:bg-rose-600 transition">Masuk</button>
            </div>
        </div>
    </nav>

    <!-- Hero Section -->
    <section id="home" class="relative bg-gradient-to-br from-rose-50 via-white to-pink-50 py-20 sm:py-32 md:py-48 overflow-hidden">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="animate-slide-up" x-data="{ demoOpen:false }">
                    <h1 class="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                        Ajukan Kredit Cepat <span class="gradient-text">1 Jam Cair</span>
                    </h1>
                ...
                <div class="relative animate-float">
                    <div class="bg-white rounded-3xl book-shadow p-8 transform rotate-2 relative z-10">
                        <img src="/assets/img/home-section.jpeg"
    ...
    <section class="py-20 bg-white relative">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <h2 class="text-4xl font-bold text-center text-gray-900 mb-4 animate-fade-in">PT BPR Supra Antrapersada</h2>
    ...
    <!-- Testimonials -->
    <section id="review" class="py-20 bg-gradient-to-br from-stone-50 to-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
