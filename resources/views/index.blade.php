                            ...
                            <div class="row">
                                <div class="col-lg-11">
                                    ...
                                    <div class="cta d-flex gap-2 mb-4 mb-lg-5" data-aos="fade-up" data-aos-delay="300">
                                        <a class="btn" href="#">Ajukan Pinjaman</a>
                    ...
                    <div class="row g-4" data-masonry="{&quot;percentPosition&quot;: true }">
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                            <div class="testimonial rounded-4 p-4">
                                <blockquote class="mb-3">
                                    &ldquo;
                                    Layanan digital BPR Supra membuat saya bisa cek status kredit dan jadwal angsuran kapan saja. Sangat memudahkan pengelolaan keuangan saya.
                                    &rdquo;
                                </blockquote>
                                <div class="testimonial-author d-flex gap-3 align-items-center">
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                            <div class="testimonial rounded-4 p-4">
                                <blockquote class="mb-3">
                                    &ldquo;
                                    Data nasabah terlindungi dan aman. Saya tidak khawatir lagi saat mengirim dokumen untuk proses kredit, karena ada jaminan keamanan dari BPR Supra.
                                    &rdquo;
                                </blockquote>
                                <div class="testimonial-author d-flex gap-3 align-items-center">
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="500">
                            <div class="testimonial rounded-4 p-4">
                                <blockquote class="mb-3">
                                    &ldquo;
                                    Kredit modal usaha dari BPR Supra sangat membantu ekspansi toko kami. Pelayanan cepat dan proses tidak berbelit membuat kami lebih fokus kembangkan usaha.
                                    &rdquo;
                                </blockquote>
                                <div class="testimonial-author d-flex gap-3 align-items-center">
