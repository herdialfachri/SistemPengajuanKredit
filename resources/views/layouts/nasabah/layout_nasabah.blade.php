...
<body>
    ...
    <div id="app">
                    ...
                    <div class="navbar-item dropdown has-divider has-user-avatar">
                        <a class="navbar-link">
                            ...
                            <div class="is-user-name">
                                <span>Hi, {{ session('user')['nama'] ?? 'Guest' }}</span>
                            </div>
        ...
        <aside class="aside is-placed-left is-expanded">
            ...
            <div class="menu is-menu-main">
                ...
                <ul class="menu-list">
                    <li>
                        <a href="{{ route('dashboard') }}" class="is-active">
                ...
                <ul class="menu-list">
                    <li>
                        <a href="{{ route('data.pengajuan') }}">
                            <span class="icon"><i class="mdi mdi-table"></i></span>
                            <span class="menu-item-label">Pengajuan Saya</span>
                        </a>
                    </li>
                    <li>
                ...
                <ul class="menu-list">
                    <li>
                        <a href="{{ route('index') }}" class="has-icon">
    ...
    <script type="text/javascript" src="assets/dashboard/js/main.min.js?v=1772427751095"></script>

    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js"></script>
    <script type="text/javascript" src="assets/dashboard/js/chart.sample.min.js"></script>
